...
public class Principal extends javax.swing.JFrame {
    ...
    public Principal(DAO d) throws ClassNotFoundException, SQLException {
        initComponents();
        setTitle("Acesso ao banco de dados");
        conexao = true;
        mudaStatus();
        this.e = d;
    }
    ...
    public Principal() throws ClassNotFoundException, SQLException {
        initComponents();
        setTitle("Acesso ao banco de dados - Grupo H");
        conexao = false;
        mudaStatus();
    }
    ...
    public void mudaStatus() {
        if (conexao) {
            ...
            lblCon.setForeground(Color.green);
        } else {
...
.getName()).log(Level.SEVERE, null, ex);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            Controller controler2 = new Controller(e);
            controler2.setText(jTextArea1);
